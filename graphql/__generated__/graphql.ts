...
export type GetMealPlansQuery = { __typename?: 'Query', getMealPlans: Array<{ __typename?: 'MealPlan', mealPlanId: number, day: any, mealTime: MealTime, cupCount: Array<{ __typename?: 'CupCount', itemId: number, cupcount: number, item: { __typename?: 'Item', itemId: number, name: string, type: ItemType, photo?: { __typename?: 'Photo', photoId: number, file: { __typename?: 'UploadedFile', fileName: string, filePath: string } } | null }, mealPlan: { __typename?: 'MealPlan', mealTime: MealTime } }>, preferences?: Array<{ __typename?: 'Preference', itemId: number, order: number }> | null, optedOut?: { __typename?: 'Student', studentId: number, student9DigitId: string } | null }> };
