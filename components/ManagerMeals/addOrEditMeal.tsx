import {GetMealPlanQuery, GetOldItemsQuery} from "../../graphql/__generated__/graphql";
        ...
        <div>
            {
                arr.map((a, i) => (
                    <div key={i}>
                        ...
                        <SelectedItemsList selectedItems={a.selectedItems} type={a.placeHolder}
                                           onChangeCupCount={handleNonVegCupCount}/>
                    </div>
                ))
            }
