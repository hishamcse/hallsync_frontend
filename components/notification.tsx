    ...
    return (
        <div style={{
            ...
            <MyCard title={'Decline'}>
                <MUIStyledTextarea width={420} val={reason} handleInput={setReason} placeHolder='Reason for rejection'
                                   rows={6}/>
                <div style={{
                    textAlign: "center",
                    marginTop: 10
        ...
        <>
            <ListItem alignItems="flex-start" sx={{}}>
                <ListItemText
                    ...
                    primary={<div style={{
                        ...
                        <IconButton
                            onClick={() => query({variables: {notificationId: props.notification.notificationId}})}>
                            <DeleteIcon style={{
                                fontSize: 22
                            }}/>
                        </IconButton>
            ...
            {props.divider && <Divider variant="fullWidth" component="li"/>}
            {
                ...
                <CustomizedDialog show={show} setShow={setShow} cardTitle={"Vote"}>
                    <VoteView notificationId={props.notification.notificationId} setShow={setShow}
                              vote={props.notification.vote!}/>
                </CustomizedDialog>
            }
        </>
    )
            ...
            <List sx={{
            ...
            }} onClick={(e) => e.stopPropagation()}>
                {
                    props.notifications.notifications.map((n, i) => (
                        <Notification divider={i !== props.notifications.notifications.length - 1}
                                      key={n.notificationId} notification={n}/>
                    ))
                }
                {
