...
export function StudentNavBar() {
    ...
    return (
        <ul>
            <ListItem active={checkRouteContains(router, activeIf.profile)} href={'/' + routes.profile}
                      imgPath={imgPaths.profile}
            ...
            {resident &&
                <ListItem active={checkRouteContains(router, activeIf.mess)} href={'/' + routes.mess}
                          imgPath={imgPaths.mess}
                          text={texts.mess} icon={<RestaurantIcon/>}/>
            }
            <ListItem active={checkRouteContains(router, activeIf.info)} href={'/' + routes.info}
                      imgPath={imgPaths.info}
    ...
    return (
        <ul>
            ...
            <ListItem active={checkRouteContains(router, routes.info)} href={'/' + routes.info} imgPath={imgPaths.info}
                      text={texts.info} icon={<SignalCellularAltOutlinedIcon/>}/>
            {
                <ListItem active={checkRouteContains(router, routes.complaints)} href={'/' + routes.complaints}
                          imgPath={imgPaths.complaints} text={texts.complaints}/>
            }
            <ListItem width={25} href='/' imgPath='/logout.svg' active={false} text='logout' onClick={logOutOnClick}
                      icon={<LogoutOutlinedIcon/>}/>
