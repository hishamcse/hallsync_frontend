...
export type GetComplaintsQuery = { __typename?: 'Query', getComplaints: Array<{ __typename?: 'Complaint', complaintId: number, createdAt: any, details: string, title: string, type: ComplaintType, student: { __typename?: 'Student', name: string, student9DigitId: string } }> };
...
export type GetComplaintsByStudentQuery = { __typename?: 'Query', getComplaintsByStudent: Array<{ __typename?: 'Complaint', complaintId: number, details: string, title: string, type: ComplaintType, student: { __typename?: 'Student', name: string, student9DigitId: string } }> };
...
export type GetComplaintsByTypeQuery = { __typename?: 'Query', getComplaintsByType: Array<{ __typename?: 'Complaint', complaintId: number, createdAt: any, details: string, title: string, type: ComplaintType, student: { __typename?: 'Student', name: string, student9DigitId: string } }> };
...
export type GetComplaintsFromDateQuery = { __typename?: 'Query', getComplaintsFromDate: Array<{ __typename?: 'Complaint', complaintId: number, type: ComplaintType, createdAt: any, details: string, title: string, student: { __typename?: 'Student', name: string, student9DigitId: string } }> };
...
export type ComplaintMutationMutation = { __typename?: 'Mutation', addComplaint: { __typename?: 'Complaint', complaintId: number, title: string, details: string, createdAt: any, type: ComplaintType, student: { __typename?: 'Student', name: string, student9DigitId: string } } };
